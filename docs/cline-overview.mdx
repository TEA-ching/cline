...
<CardGroup cols={1}>
  <Card title="SDK" icon="cube" href="https://docs.ai-ml.pp.ua/sdk/overview">
...
<CardGroup cols={2}>
  ...
  <Card title="VS Code Extension" icon="code" href="https://github.com/TEA-ching/cline/releases">
