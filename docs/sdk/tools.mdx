...
For complete examples of tools in action, see the [cli-agent](https://github.com/TEA-ching/cline/tree/main/apps/examples/cli-agent) (shell tool) and [code-review-bot](https://github.com/TEA-ching/cline/tree/main/apps/examples/code-review-bot) (multiple tools with completion lifecycle).
