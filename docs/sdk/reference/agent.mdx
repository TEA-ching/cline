...
title: "Agent"
sidebarTitle: "Agent"
description: "API reference for Agent / AgentRuntime from @sctg/cline-agents."
---

`Agent` is an alias for `AgentRuntime` from `@sctg/cline-agents`.

```typescript
import { Agent, AgentRuntime, createAgent, createAgentRuntime } from "@sctg/cline-sdk"
```
