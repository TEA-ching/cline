...
describe("buildUpdateManifest", () => {
	test("maps updater artifacts to darwin platform entries", () => {
		...
		expect(manifest.platforms["darwin-aarch64"]).toEqual({
			...
			url: "https://github.com/TEA-ching/cline/releases/download/desktop-v0.1.0/Cline-Code_0.1.0_aarch64.app.tar.gz",
		});
		expect(manifest.platforms["darwin-x86_64"]).toEqual({
			signature: "sig-x86_64",
			url: "https://github.com/TEA-ching/cline/releases/download/desktop-v0.1.0/Cline-Code_0.1.0_x86_64.app.tar.gz",
		});
