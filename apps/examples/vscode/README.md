# `apps/examples/vscode` (`@sctg/cline-vscode`)
...
bun -F @sctg/cline-vscode build

# Typecheck
bun -F @sctg/cline-vscode typecheck
```

To run locally in VS Code:

1. Build the extension: `bun -F @sctg/cline-vscode build`.
