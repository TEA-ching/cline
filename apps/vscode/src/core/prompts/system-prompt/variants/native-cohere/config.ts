...
export const config = createVariant(ModelFamily.NATIVE_COHERE)
	.description("Cohere models with native tool calling")
	.version(1)
	.tags("cohere", "production", "native_tools")
	.labels({
		stable: 1,
		production: 1,
		advanced: 1,
...
export type NativeCohereVariantConfig = typeof config
