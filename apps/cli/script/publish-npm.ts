...
const hostSdkPackages = [
	{ name: "@sctg/cline-sdk", directory: "sdk" },
	{ name: "@sctg/cline-core", directory: "core" },
	{ name: "@sctg/cline-agents", directory: "agents" },
	{ name: "@sctg/cline-llms", directory: "llms" },
	{ name: "@sctg/cline-shared", directory: "shared" },
] as const;
