...
// key) is needed; every other `@sctg/cline-llms` export stays real because
// `@sctg/cline-core` re-exports them.
vi.mock("@sctg/cline-llms", async (importOriginal) => ({
	...(await importOriginal<typeof import("@sctg/cline-llms")>()),
