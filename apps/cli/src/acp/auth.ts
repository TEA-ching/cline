import type { ProviderSettingsManager } from "@sctg/cline-core";
import { loginAndSaveProviderOAuthCredentials } from "@sctg/cline-core";
...
async function performOAuthLogin(input: {
	...
	const [{ createOAuthClientCallbacks }, { default: open }] = await Promise.all(
		[import("@sctg/cline-core"), import("open")],
	);
