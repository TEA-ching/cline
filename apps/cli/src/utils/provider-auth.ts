import { Llms, type ProviderSettings } from "@sctg/cline-core";
import { isOAuthProviderId } from "@sctg/cline-shared";
...
/**
 * Re-exports `isOAuthProviderId` from `@sctg/cline-shared` so the CLI has a
