...
<td align="center">
<a href="https://github.com/TEA-ching/cline/releases" target="_blank">VS Code Extension</a>
</td>
<td align="center">
...
<td align="center">
<a href="https://github.com/TEA-ching/cline/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop" target="_blank">Feature Requests</a>
</td>
<td align="center">
<a href="https://docs.ai-ml.pp.ua" target="_blank">Docs</a>
</td>
</tbody>
</table>
</div>

Run Cline in your terminal. Interactive chat for paired sessions, or fully headless for CI/CD and scripting. The CLI shares its agent core with the [Cline VS Code extension](https://github.com/TEA-ching/cline/releases), JetBrains plugin, and SDK, so plan/act modes, MCP servers, checkpoints, rules, skills, and provider configuration all behave the same across surfaces.
...
[Apache 2.0 © Cline Bot Inc.](https://github.com/TEA-ching/cline/blob/main/LICENSE)
