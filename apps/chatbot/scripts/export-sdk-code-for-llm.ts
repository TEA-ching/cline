...
- **Agent Runtime**: @cline/agents package for LLM interaction
...
async function main() {
    ...
    md += `framework: react\n`;
    md += `stack: "React 19 + TypeScript + Vite + HeroUI + @cline/agents"\n`;
    md += `generated: "${now}"\n`;
    md += `slim_mode: ${slim}\n`;
    ...
    if (withIndex) {
        ...
        idx += `Stack: React 19 + TypeScript + Vite + HeroUI + @cline/agents\n\n`;
        idx += `FILES\n`;
