 ...
 *
 * CLI usage:
 *   cline plugin install https://github.com/TEA-ching/cline/blob/main/sdk/examples/plugins/custom-compaction.ts --cwd .
 *   cline -i "Search the codebase for dispatcher usage, then summarize it"
 */

import type { AgentPlugin, Message, ToolResultContent } from "@sctg/cline-core";
import { estimateTokens as estimateTokensFromChars } from "@sctg/cline-shared";
