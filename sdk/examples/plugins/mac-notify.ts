 ...
 *
 * CLI usage:
 *   cline plugin install https://github.com/TEA-ching/cline/blob/main/sdk/examples/plugins/mac-notify.ts --cwd .
 *   cline -i "Run the test suite"
 */

import { execFile } from "node:child_process";
import type { AgentPlugin, AgentRunResult } from "@sctg/cline-core";
