...
node -e "
  const { HubWebSocketClient } = require('@sctg/cline-core');
...
cline plugin install https://github.com/TEA-ching/cline/blob/main/sdk/examples/plugins/automation-events.ts
