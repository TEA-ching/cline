...
<td align="center">
<a href="https://github.com/TEA-ching/cline/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop" target="_blank"><strong>Feature Requests</strong></a>
</td>
</tbody>
</table>
</div>

The Cline SDK is a TypeScript framework for building AI agents that can edit files, run shell commands, browse the web, call APIs, and use any custom tool you give them. It's the same engine that powers [Cline](https://github.com/TEA-ching/cline), packaged as a library you can embed in your own applications.
...
| `@sctg/cline-core` | Sessions, persistence, built-in tools, config discovery, RPC |
| `@sctg/cline-agents` | Stateless agent loop with tool execution and streaming |
| `@sctg/cline-llms` | LLM provider gateway (Anthropic, OpenAI, Google, Bedrock, Mistral, and more) |
| `@sctg/cline-shared` | Types, tool creation helpers, hook engine |

`@sctg/cline-sdk` is an alias for `@sctg/cline-core` that re-exports from all packages, so a single install gives you the full API. The individual packages are available if you want a minimal dependency footprint.
...
Full documentation at [docs.ai-ml.pp.ua/sdk](https://docs.ai-ml.pp.ua/sdk/overview):

- [Quickstart](https://docs.ai-ml.pp.ua/sdk/quickstart) -- zero to running agent in 5 minutes
- [Core Concepts](https://docs.ai-ml.pp.ua/sdk/agents) -- agents, sessions, tools, events, extensions, hooks
- [Guides](https://docs.ai-ml.pp.ua/sdk/guides/building-an-agent) -- end-to-end tutorials for common patterns
- [Architecture](https://docs.ai-ml.pp.ua/sdk/architecture/overview) -- how the SDK is structured and why
- [API Reference](https://docs.ai-ml.pp.ua/sdk/reference/cline-core) -- every method, type, and config option
