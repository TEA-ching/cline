...
import { setHomeDirIfUnset } from "@sctg/cline-shared/storage";
...
export class LocalRuntimeHost implements RuntimeHost {
	...
	private async startResolvedSession(
		...
		// interruption, or an auto-continue after a keypool retry) is not
		...
		if (
			...
			existingMetadataOnContinuation =
				existingManifestForContinuation?.metadata as
