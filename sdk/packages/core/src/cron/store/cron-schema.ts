import type { SqliteDb } from "@sctg/cline-shared/db";

/**
 * Bootstrap the dedicated cron.db schema. Unlike @sctg/cline-shared's
 * `ensureSessionSchema`, this schema is fully owned by @sctg/cline-core
