...
import { PLUGIN_FILE_EXTENSIONS } from "@sctg/cline-shared";
...
const HOST_PROVIDED_SDK_SPECIFIERS = [
	...
	"@sctg/cline-core",
	"@sctg/cline-core/hub",
	"@sctg/cline-core/hub/daemon-entry",
	"@sctg/cline-core/telemetry",
	"@sctg/cline-llms",
	"@sctg/cline-llms/browser",
	"@sctg/cline-shared",
	"@sctg/cline-shared/automation",
	"@sctg/cline-shared/browser",
	"@sctg/cline-shared/storage",
	"@sctg/cline-shared/db",
	"@sctg/cline-shared/types",
];
...
function collectWorkspaceAliases(root: string): Record<string, string> {
	...
	const candidates: Record<string, string> = {
		"@sctg/cline-sdk": resolve(root, "packages/sdk/src/index.ts"),
		"@sctg/cline-agents": resolve(root, "packages/agents/src/index.ts"),
		"@sctg/cline-core": resolve(root, "packages/core/src/index.ts"),
		"@sctg/cline-llms": resolve(root, "packages/llms/src/index.ts"),
		"@sctg/cline-shared": resolve(root, "packages/shared/src/index.ts"),
		"@sctg/cline-shared/storage": resolve(
			root,
			"packages/shared/src/storage/index.ts",
		),
		"@sctg/cline-shared/db": resolve(root, "packages/shared/src/db/index.ts"),
	};
...
export async function importPluginModule(
	...
	const jiti = createJiti(pluginPath, {
		...
		// every nested import in the plugin, sees `import "@sctg/cline-core"` with no
