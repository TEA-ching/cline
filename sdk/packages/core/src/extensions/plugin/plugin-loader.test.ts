...
describe("plugin-loader", () => {
	...
	beforeAll(async () => {
		...
		await writeFile(
			...
			[
				"import { sdkMarker } from '@sctg/cline-shared';",
				"export default {",
				"  name: sdkMarker,",
				"  manifest: { capabilities: ['tools'] },",
				"};",
		...
		await writeFile(
			...
			[
				"import { safeJsonStringify } from '@sctg/cline-shared';",
				"import { resolveClineDataDir } from '@sctg/cline-shared/storage';",
		...
		await writeFile(
			...
			[
				"import { createConfiguredTelemetryHandle } from '@sctg/cline-core/telemetry';",
				"export default {",
