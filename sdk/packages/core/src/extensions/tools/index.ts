...
// Zod Utilities
export { validateWithZod, zodToJsonSchema } from "@sctg/cline-shared";
// Constants
...
import { type AgentTool, getDefaultShell } from "@sctg/cline-shared";
 ...
 * @example
 * ```typescript
 * import { Agent, createBuiltinTools } from "@sctg/cline-core"
 *
