...
import { loadSqliteDb, nowIso, type SqliteDb } from "@sctg/cline-shared/db";
import { resolveDbDataDir } from "@sctg/cline-shared/storage";
...
export class SqliteTeamStore implements TeamStore {
	...
	private ensureSchema(db: SqliteDb): void {
		...
		// Session/schedule schemas use separate migration paths in @sctg/cline-shared.
		db.exec(`
