/**
 * Adapter: wrap a custom `ApiHandler` (from the `@sctg/cline-llms` handler registry)
 ...
 * `@sctg/cline-llms` `compat.ts`.
 */

import type { ApiHandler, ApiStreamChunk } from "@sctg/cline-llms";
import type {
	AgentModel,
	AgentModelEvent,
