...
export interface SessionTeamProgressEvent {
	sessionId: string;
	teamName: string;
	lifecycle: import("@sctg/cline-shared").TeamProgressLifecycleEvent;
	summary: import("@sctg/cline-shared").TeamProgressSummary;
}
...
export type CoreSessionEvent =
	...
	| {
			...
			payload: {
				sessionId: string;
				event: import("@sctg/cline-shared").AgentEvent;
