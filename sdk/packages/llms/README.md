...
`@sctg/cline-llms` is the model and provider layer for the Cline SDK. It gives
...
`@sctg/cline-llms` and `@sctg/cline-shared`.

### Models

Use `@sctg/cline-llms/models` when you need generated provider/model metadata for
...
- Workspace overview: [README.md](https://github.com/TEA-ching/cline/blob/main/README.md)
- API and architecture references: [DOC.md](https://github.com/TEA-ching/cline/blob/main/DOC.md), [ARCHITECTURE.md](https://github.com/TEA-ching/cline/blob/main/ARCHITECTURE.md)
